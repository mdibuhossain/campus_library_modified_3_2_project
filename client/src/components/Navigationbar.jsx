      ...
      <Menu as="div" className="ml-3 relative z-50">
        <div>
          <Menu.Button className="bg-gray-800 flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
            ...
            <span className="mx-2 font-semibold text-gray-100">
...
const DropdownItem = (prop, active) => {
  return (
    <NavLink
      to={prop.to}
      className={
        "bg-gray-700 hover:bg-gray-800 block text-sm text-gray-200 text-center"
      }
    >
            ...
            if (item?.list?.length) {
              ...
              return (
                <Menu.Item key={item?.name}>
                  {({ active }) => DropdownItem(item, active)}
                </Menu.Item>
              );
            }
          })}
                ...
                <div className="flex items-center justify-between h-16">
                  <div className="relative flex items-center flex-grow">
                    <div className="flex-shrink-0">
                      <NavLink
                        to="/"
                        className="flex flex-row items-center gap-3 text-[#a8ff01] font-rubik_doodle text-2xl"
                      >
                        <img
                          className="w-14"
                    ...
                    <div
                      className="xs:block md:hidden absolute z-50"
                      style={{
                        left: "50%",
